...
export default function ProceduralLayer({
    ...
    return (
        ...
        >
            ...
            />
            {/*
                The manual blink overlay that used to live here rendered as an
                unstyled, badly-positioned black bar (missing --mochi-eyelid
                theme value, offset from the actual eye position depending on
                render context) — see chat history / changes.md for details.
                Removed rather than re-themed: eyesClosed-driven states
                (sleeping, yawning) already render correctly through the
                character's own art via StateToClipMap, so no replacement
